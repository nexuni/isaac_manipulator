...
def launch_setup(context, *args, **kwargs):
    ...
    grasp_parent_frame = ''
    if gripper_type.perform(context) == 'robotiq_hande':
        grasp_parent_frame = 'robotiq_hande_coupler'
    elif gripper_type.perform(context) == 'robotiq_2f_140':
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution([FindPackageShare('isaac_manipulator_pick_and_place'),
                                'urdf', 'ur_robotiq_hande.urdf.xacro']),
            # PathJoinSubstitution([FindPackageShare('isaac_manipulator_pick_and_place'),
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            choices=['robotiq_2f_85', 'robotiq_2f_140', 'robotiq_hande'],
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
